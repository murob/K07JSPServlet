...
pageContext.setAttribute("PageMember2", new MemberDTO("Nakja", "1234", "성강사", null));//생성자를 통해 초기화
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	*/
	...
	<%--
		page영역에 저장된 속성 값은 새로운 페이지에 대한 요청이
