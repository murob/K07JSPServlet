...
<body>
	...
	<br />
	\${htmlStr } : ${htmlStr } <%-- \${} : EL문 주석으로 그대로 출력된다. --%>
	
	<!-- 
	false일 때는 HTML이 해석되어져서 화면에 출력된다. JS의 innerHTML()과
	동일하다.
	 -->
	...
	<!-- 
	-out 태그에 value속성의 값이 null일 때는 default속성에
	지정된 값이 출력된다.
	...
	<a href="<c:url value="/08Board/List.jsp?pageNum=" /><c:out value="${param.nowPage }" default="1" />">
		회원제게시판 리스트 바로가기</a>
</body>
</html>