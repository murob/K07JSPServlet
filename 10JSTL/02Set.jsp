...
<body>
	...
	<ul>
		...
		인자생성자를 통해 DTO객체를 생성한 후 request영역에 속성을 저장한다.
		 -->
		<h3>인자생성자로 설정</h3>
		<c:set var="argsMember" value='<%=new MemberDTO("KIM", "1111", "조이", null) %>' scope="request" />
		<!-- 
		영역에 저장될 때 Object형으로 자동캐스팅 되므로 사용시 해당
		자료형으로 형변환 해야한다.
		...
		<!-- 
		EL로 출력시에는 별도의 형변환이 필요없이, 속성명의 중복이 없다면
