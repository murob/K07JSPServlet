...
<body>	
	...
	<!-- 
		...
		만약, enctype 속성이 있다면 request객체를 통해 폼값을 받을 수 있다.
	 -->
	<form name="writeFrm" method="post" action="../mvcboard/pass.do" onsubmit="return formValidate(this)l">
		<!-- 
			idx : 게시물의 일련번호
		...
		<table border="1" width="90%">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" onclick="location.href='../mvcboard/list.do';">리스트바로가기</button>
				</td>
			</tr>
		</table>
	</form>
