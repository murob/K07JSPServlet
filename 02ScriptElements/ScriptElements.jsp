<%--
	...
	지시어(Directive) : 페이지 속성을 지정하거나 외부문서를
		포함할 때 사용한다. (page, include, taglib이 있다.)
--%>
...
<%--
	선언부(Declaration): 스크립트릿이나 표현식에서 사용할
		메소드를 선언할 때 사용한다. 함수는 중복해서 사용하는
		경우가 많으므로 주로 src영역을 사용한다.
--%>
<%!
...
<head>
<meta charset="UTF-8">
<title>ScriptElements.jspitle here</title>
</head>
<body>
	...
	out.println("1에서 100까지의 합 : "+MyClass.myFunc(1,100));
	%>
	
	<%--
	스크립트릿(Scriptlet) : 주로 JSP코드를 작성하고 실행할 때 사용하는
		영역이다. 스트립트릿은 head영역, body영역 어디서든 사용할 수 있다.
