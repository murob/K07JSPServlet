...
<body>
	...
	*/
	...
	if( !(name==null || name.equals("")) ){
		...
		//스크립트릿 내부에 JS를 작성할 때는 out.println()을 사용한다.
// 		out.println("<script>");
...
<%
	...
	*/
	...
	/*
	checkbox는 2개이상의 항목을 선택할 수 있으므로 getParameterValues()를
	사용한다. 항목중 체크된 것만 서버로 전송되고, 파라미터명이 틀리거나
	...
	*/
	...
	hasMoreElements() : 객체 남은 폼값의 이름이 있는지 확인한다.
