...
<body>
	...
	*/
	...
	%>
	<a href="RequestParameter.jsp?name=<%=encodeName%>&id=hong&sex=man&favorite=&self_intro=">Get방식</a>
	<br />
	<br />
	<script>
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp" onsubmit="return checkForm(this);">
		...
		<br />
	 	관심사항 : 
	 		...
	 		<input type="checkbox" name="favorite" value="economic" checked="checked" />경제
	 	...
	 	<br />
	 	자기소개 : <textarea name="self_intro" cols="30" rows="10">나는 부유한 집안에서 태어났다.</textarea>
	 	<br />
	 		<input type="submit" value="POST방식" />
