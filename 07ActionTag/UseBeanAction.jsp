...
<body>
	...
	<%--
		...
		import moder.MemberDTO; //1.MemberDTO클래스를 임포트한다.
		MemberDTO memberDTO = (MemberDTO)request.getAttribute("member"); //2.request영역에 저장된 member속성을 읽어온다.
		if(memberDTO==null){ //3.만약 객체가 null값이면..
			memberDTO = new MemberDTO(); //4.객체를 새롭게 생성하여 request영역에 저장한다.
