...
<body>
	...
	*/
	...
	<ul>
		...
		<!-- String, Integer와 같은 기본객체는 별도의 형변환 없이 사용할 수 있다. -->
		<li>
		...
		*/
		...
		않고도 읽어올 수 있고, 형변환을 별도로 하지 않아도 된다.
		또한, 산술연산시 int형으로 변환도 필요없다.
		getter의 호출없이 멤버변수의 이름만으로 저장된 값을 바로 읽어 출력할 수
		있다. 따라서, JSP코드를 사용할 때보다 EL을 사용하면 훨씬 더 간편해진다.
		 -->
